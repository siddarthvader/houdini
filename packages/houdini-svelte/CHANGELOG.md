...
-   Updated dependencies [[`0acc49de`](https://github.com/HoudiniGraphql/houdini/commit/0acc49de8317e68cf350d07b0276a1af467d3252)]:
    -   houdini@1.5.10
...
-   Updated dependencies [[`aa557d67`](https://github.com/HoudiniGraphql/houdini/commit/aa557d67cba6042d3a421bae9754ae2250257c3e)]:
    -   houdini@1.5.9
...
-   Updated dependencies [[`621074a8`](https://github.com/HoudiniGraphql/houdini/commit/621074a86a085a34b8df599f1b41382cac6f69e1)]:
    -   houdini@1.5.8
...
-   [#1487](https://github.com/HoudiniGraphql/houdini/pull/1487) [`fb6a0aed`](https://github.com/HoudiniGraphql/houdini/commit/fb6a0aeda0e295476d5a5a7a44125e632978f4ca) Thanks [@SeppahBaws](https://github.com/SeppahBaws)! - Fix incorrect typings for automatic load event parameter

-   Updated dependencies [[`31108851`](https://github.com/HoudiniGraphql/houdini/commit/31108851d4a0c0480530807f4de751520fe35278)]:
    -   houdini@1.5.6
...
-   [#1478](https://github.com/HoudiniGraphql/houdini/pull/1478) [`74fed70f`](https://github.com/HoudiniGraphql/houdini/commit/74fed70fc9de0881644958336eb7c2ea376a8116) Thanks [@rgon](https://github.com/rgon)! - properly warn against using page/layout queries when not include-ing .js files in houdini.config.js

## 2.1.14

### Patch Changes

-   Updated dependencies [[`3fe26b17`](https://github.com/HoudiniGraphql/houdini/commit/3fe26b17dfb758e329a5d24876862f238e8c71f2)]:
    -   houdini@1.5.5
...
-   [#1469](https://github.com/HoudiniGraphql/houdini/pull/1469) [`239a6e83`](https://github.com/HoudiniGraphql/houdini/commit/239a6e8394ae9507dea31b7762c375db53da2a36) Thanks [@SeppahBaws](https://github.com/SeppahBaws)! - Properly generate load function with renamed props for component queries with an `@load` directive
...
-   [#1362](https://github.com/HoudiniGraphql/houdini/pull/1362) [`8d4226ed`](https://github.com/HoudiniGraphql/houdini/commit/8d4226ed6a840868cfbfee0584b06f621d86bc37) Thanks @SeppahBaws! - Fix return types for pagination loadNextPage and loadPreviousPage
...
-   [#1222](https://github.com/HoudiniGraphql/houdini/pull/1222) [`7ae3abc5`](https://github.com/HoudiniGraphql/houdini/commit/7ae3abc527a9c19d27ab97a26bfd06e1310c859e) @eikaramba - Fix bug extending load functions that are wrapped by a utility
...
-   [#1118](https://github.com/HoudiniGraphql/houdini/pull/1118) [`6f9eeb6`](https://github.com/HoudiniGraphql/houdini/commit/6f9eeb693fd6223b9b4c4af8cdb93a57c8e5b777) @fnimick - Include types in houdini-svelte/runtime import (resolves QueryStoreFetchParams import failures)
...
-   [#1053](https://github.com/HoudiniGraphql/houdini/pull/1053) [`5961ffe`](https://github.com/HoudiniGraphql/houdini/commit/5961ffedf135a7201beea777d8d3d4415a9ca37e) Thanks [@knd775](https://github.com/knd775)! - Fix duplicate virtual `+layout.js` files
...
-   [#958](https://github.com/HoudiniGraphql/houdini/pull/958) [`8e2f8e0`](https://github.com/HoudiniGraphql/houdini/commit/8e2f8e0d5b96f34a01dfcbc510ab1b0c3cfa9822) Thanks [@jycouet](https://github.com/jycouet)! - paginate directive now supports a SinglePage mode (in addition to the Infinite one already present)
